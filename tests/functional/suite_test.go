...
// These tests use Gingko (BDD-style Go testing framework). Refer to
// http://onsi.github.io/gingko to learn more.
...
var _ = BeforeSuite(func() {
	...
	// Get CRDs to setup test environment.
	...
	// TODO(beagles): Add all schemas our operator "Owns". Keep in sync
	// with related SetupWithManager impls in the related controller
